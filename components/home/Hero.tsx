...
export default function Hero() {
    return (
        <main className="relative mx-auto h-[786.7755px] w-[1440px]">
            <section className="absolute left-[150px] top-[186.7755px] h-[600px] w-[1140px] overflow-hidden rounded-[10px]">
