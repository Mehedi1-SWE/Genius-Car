...
export default function Navbar() {
    return (
        <nav className="relative mx-auto mt-[50px] h-[86.7755px] w-[1140px]">
            {/* Left Layout */}
            <div className="absolute left-0 top-0 h-[86.7755px] w-[107px]">
                ...
                <div className="absolute left-0 top-[59.78px] flex h-[27px] w-[107px] items-center justify-center">
                    <span className="font-['Open_Sans'] text-center text-[20px] font-bold leading-[100%] text-[#444444]">Car Doctor</span>
                </div>
            </div>
