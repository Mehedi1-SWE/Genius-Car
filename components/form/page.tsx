...
import FormNavbar from "../formNavbar/page";
    ...
    return (
        <>
            ...
            <main className="relative mx-auto -mt-[137px] h-[1100px] w-[1440px]">
                ...
                {/* Right Layout */}
                <div className="absolute left-[679px] top-[160px] h-[919px] w-[611px] rounded-[10px] border-[1px] border-[#D0D0D0]">

                    {/* Form Layout */}
                    <form className="absolute left-[75px] top-[75px] h-[769px] w-[461px]">

                        {/* Sign Up */}
                        <div className="absolute left-[155px] top-[0px] h-[48px] w-[151px]">
                        ...
                        {/* 2nd Layout */}
                        <div className="absolute left-[0px] top-[98px] h-[671px] w-[461px]">

                            {/* 1st Inner Layout */}
                            <div className="absolute left-[0px] top-[0px] h-[462px] w-[461px] rounded-[10px]">

                                {/* 1st Layout */}
                                <div className="absolute left-[0px] top-[0px] h-[102px] w-[461px] rounded-[10px]">

                                    {/* Name */}
                                    <div className="absolute left-[0px] top-[0px] h-[22px] w-[51px]">
                                ...
                                {/* 2nd Layout */}
                                <div className="absolute left-[0px] top-[137px] h-[102px] w-[461px] rounded-[10px]">
                                ...
                                {/* 3rd Layout */}
                                <div className="absolute left-[0px] top-[267px] h-[102px] w-[461px] rounded-[10px]">
                                ...
                                {/* 4th Layout */}
                                <div className="absolute left-[0px] top-[398px] h-[64px] w-[461px] rounded-[10px] bg-[#FF3811]">
                            ...
                            {/* 2nd Inner Layout */}
                            <div className="absolute left-[132px] top-[492px] h-[107px] w-[197px]">
                            ...
                            {/* 3rd Inner Layout */}
                            <div className="absolute left-[95px] top-[649px] h-[22px] w-[272px]">
                                <span className="font-['Inter'] text-[18px] font-normal leading-[100%] tracking-[0%] text-[#737373]">
                                    Already have an account?{" "}
                                </span>
                                <span className="font-['Inter'] text-[18px] font-semibold leading-[100%] tracking-[0%] text-[#FF3811]">
                                    Login
                                </span>
                            </div>
